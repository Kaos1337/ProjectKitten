...
/**
 * A node of abstract syntax representing the declaration of a constructor or method of a Kitten class.
 *
...
public abstract class CodeDeclaration extends ClassMemberDeclaration {
	...
	/**
	 * The abstract syntax of the formal parameters of the constructor or method. This might be {@code null}.
	 */
	...
	/**
	 * The signature of this constructor or method. This is {@code null} if this constructor or method has not been type-checked yet.
	 */
	 ...
	 *
	 * @param pos
	 *            the starting position in the source file of the concrete syntax represented by this abstract syntax
	 * @param formals
	 *            the abstract syntax of the formal parameters of the constructor or method
	 * @param body
	 *            the abstract syntax of the body of the constructor or method
	 * @param next
	 *            the abstract syntax of the declaration of the next class member, if any
	 */
	 ...
	 *
	 * @return the signature of this method or constructor declaration. Yields {@code null} if type-checking has not been performed yet
	 */
	...
	/**
	 * Translates this constructor or method into intermediate Kitten code. This amounts to translating its body with a continuation containing a {@code return} bytecode. This way, if a method does not have an explicit {@code return} statement, it is
	 * automatically put at its end.
	 *
	 * @param done
	...
	/**
	 * Auxiliary method that translates into Kitten bytecode all class members that are referenced from the given block and the blocks reachable from it.
	 *
	 * @param block
	 *            the block
	 * @param done
	...
	private void translateReferenced(Block block, Set<ClassMemberSignature> done, Set<Block> blocksDone) {
		...
		// aggiungiamo test e fixture della classe di partenza
		process(this.getSignature().getDefiningClass(), done);
