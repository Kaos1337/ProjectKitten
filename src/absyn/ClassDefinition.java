...
public class ClassDefinition extends Absyn {
	...
	/**
	 * The sequence of fields or methods declarations. This might be
	 * {@code null}.
	 */
	...
	/**
	 * Yields the name of the superclass of the class defined with this abstract
	 * syntax.
	 *
	 * @return the name of the superclass of the class defined with this
	 *         abstract syntax
	 */
	 ...
	 *         {@code null} if there is no declaration inside this class
	 *         definition
	 */
	 ...
	 *
	 * @return the static type of this class definition. It yields {@code null}
	 ...
	 * of this class. It writes the prefix specifying the paper size and
	 * orientation, then puts a node for this class definition, with three
	 * children corresponding to {@link #name}, {@link #superclassName} and
	 * {@link #declarations}, if any. Then it builds the subtrees rooted at
	 * those children.
	 *
	 * @param where
	 *            the file where the dot representation must be written
	 * @throws IOException
	 *             if there is an error while writing into {@code where}
	 */
	...
	/**
	 * Writes in a file named as this class (plus the trailing {@code .dot}) a
	 * dot representation of the abstract syntax of this class.
	 *
	 * @param directory
	 *            the directory where the file must be dumped
	 * @throws IOException
	 *             if the dot file cannot be created
	 */
	...
	/**
	 * Adds, to the given class, the signatures of the fields, constructors and
	 * methods of this class definition.
	 *
	 * @param clazz
	 *            the class where the signatures of fields, constructors and
	...
	/**
	 * Type-checks this class definition. Namely, it type-checks its members and
	 * checks that the empty constructor exists.
	 *
	 * @param currentClass
	 *            the semantical type of this class. This will be bound to the
	 *            implicit {@code this} parameter of all its constructors and
	 *            methods
	 */
	...
	/**
	 * Translates this class definition into intermediate Kitten code. Only the
	 * methods reachable from {@code main} are compiled, if any.
	 *
	 * @return the program reachable from the {@code main} method of the class
	 *         compiled by Kitten
	 */
